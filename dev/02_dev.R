...
#golem::add_module(name = "data_reader") # Name of the module
#golem::add_module(name = "explore") # Name of the module
#golem::add_module(name = "two_samples") # Name of the module
#golem::add_module(name = "multi_group") # Name of the module
#golem::add_module(name = "lin_reg") # Name of the module
